...
if sales_file and stock_file and master_file:
  ...
  st.info("الرجاء رفع الملفات الثلاثة من القائمة الجانبية في اليسار لبدء الحسابات.")    total_days = max(total_days, 1)  # تجنب القسمة على صفر
    ...
    st.info("القائمة الجانبية في اليسار لبدء الحسابات")
الحسابات: {e}")

else:
  st.info("الرجاء رفع الملفات الثلاثة من القائمة الجانبية في اليسار لبدء
